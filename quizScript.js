...
// quiz method take in question options and answer arrays.
      ...
      function checkAnswer(selectedOption) {
        ...
        // if the user answer is right increase the points variable by 1
        if (userChoice == correctAnswer) {
          ...
          // set the colour of feed back text to green and add a green box shadow arround the quiz container.
...
// if the answer is wrong 
      ...
      function endOfQuiz() {
        ...
        progrss.style.display = "none";// hide the progress bar
  ...
  personalizedMessage.style.color ="red"// sets the colour of the text to red
    ...
    // Function called when user clicks load menu again 
      function loadMenu() {
       ...
       //makes the progess and quiz box variable and also hides the replay menu 
   ...
   // 2d array to store options
    ...
    [
      ...
      const hardAnswers = [
       ...
       //pass the above hard level arrays in to the quiz method 
